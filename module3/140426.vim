...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
lcd ~/eltex/module3
tabnext
edit ~/eltex/module3/7/receiver.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
lcd ~/eltex/module3
tabnext
edit ~/eltex/module3/3/contact.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 81 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
lcd ~/eltex/module3
tabnext
edit ~/eltex/module3/3/contact.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 8
set stal=1
badd +0 ~/eltex/module3/3/contact.h
badd +0 ~/eltex/module3/3/contact.c
badd +0 ~/eltex/module3/3/main.c
badd +1 ~/eltex/module3/5/main.c
badd +1 ~/eltex/module3/7/sender.c
badd +0 ~/eltex/module3/6/client.c
badd +0 ~/eltex/module3/6/server.c
badd +0 ~/eltex/module3/7/receiver.c
